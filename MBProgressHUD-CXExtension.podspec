#
# Be sure to run `pod lib lint MBProgressHUD-CXExtension.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'MBProgressHUD-CXExtension'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MBProgressHUD-CXExtension.'
